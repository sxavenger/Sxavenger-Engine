...
bool ImGui::BeginMenuEx(const char* label, const char* icon, bool enabled)
{
    ...
    // The first menu in a Outliner isn't so hovering doesn't get across (otherwise e.g. resizing borders with ImGuiButtonFlags_FlattenChildren would react), but top-most BeginMenu() will bypass that limitation.
