...
public:
	...
	// Detection structure
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief 衝突判定の結果(衝突有無とめり込み情報)を保持する構造体
	struct Detection {
	public:
...
private:
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief 2つの境界の組み合わせごとに衝突判定を行う内部ヘルパー(visitorとして使用)
