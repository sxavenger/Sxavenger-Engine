...
public:
	...
	// Meshlet structure
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief メッシュシェーダー用にメッシュを小単位(メッシュレット)へ分割したGPUバッファ群
	struct Meshlet {
	public:
		...
		////////////////////////////////////////////////////////////////////////////////////////////
		//! @brief メッシュレット内の1三角形を構成するローカル頂点index(各10bit)
		...
		////////////////////////////////////////////////////////////////////////////////////////////
		//! @brief 1メッシュレットの頂点/三角形のオフセットと数(meshopt_Meshlet相当)
		struct MeshletData {
		...
		////////////////////////////////////////////////////////////////////////////////////////////
		//! @brief メッシュレットのカリング用境界情報(境界球と法線コーン)
	...
	public:
		...
		static constexpr size_t kMaxPrimitives        = 128;
		static constexpr UINT kAmplificationNumthread = 32;
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief メッシュからレイトレ用BLAS(ボトムレベル加速構造)を構築・保持する構造体
...
public:
	...
	DELETE_COPY(InputMesh)
	DEFAULT_MOVE(InputMesh)
