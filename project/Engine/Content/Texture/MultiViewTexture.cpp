...
void MultiViewTexture::TransitionBeginRenderTarget(const DirectXThreadContext* context) {
...
void MultiViewTexture::TransitionEndRenderTarget(const DirectXThreadContext* context) {
	Assert(IsCreatedRTV(), "Not create RTV."); //!< RTVが生成されていない
...
void MultiViewTexture::ClearRenderTarget(const DirectXThreadContext* context) {
	Assert(IsCreatedRTV(), "Not create RTV."); //!< RTVが生成されていない
...
void MultiViewTexture::TransitionBeginUnordered(const DirectXThreadContext* context) {
...
void MultiViewTexture::TransitionEndUnordered(const DirectXThreadContext* context) {
	Assert(IsCreatedUAV(), "Not create UAV."); //!< RTVが生成されていない
...
bool MultiViewTexture::IsCreatedSRV() const {
	return viewRecorder_.test(ViewType::kSRV);
}

bool MultiViewTexture::IsCreatedRTV() const {
	return viewRecorder_.test(ViewType::kRTV);
}

bool MultiViewTexture::IsCreatedUAV() const {
