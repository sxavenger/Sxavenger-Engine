...
void ShaderReflectionTable::Create(IDxcBlob* blob, ShaderVisibility visibility) {
...
void ShaderReflectionTable::Marge(ShaderReflectionTable* other) {
...
void ShaderReflectionTable::Bind(const std::string& bufferName, const BindBuffer& buffer) {
...
void ShaderReflectionTable::BindGraphicsParameter(ID3D12GraphicsCommandList* commandList) {
...
GraphicsRootSignatureDesc ShaderReflectionTable::CreateRootSignatureDesc() {
...
void ShaderReflectionTable::MargeBufferInfo(const std::string& key, const BufferInfo& value) {
...
ComPtr<ID3D12ShaderReflection> ShaderReflectionTable::CreateReflection(IDxcBlob* blob) {
...
void ShaderReflectionTable::ReflectBuffer(ID3D12ShaderReflection* reflection, ShaderVisibility visibility) {
...
void ShaderReflectionTable::ReflectInput(ID3D12ShaderReflection* reflection, ShaderVisibility visibility) {
...
DXGI_FORMAT ShaderReflectionTable::GetFormat(D3D_REGISTER_COMPONENT_TYPE type, BYTE mask) const {
