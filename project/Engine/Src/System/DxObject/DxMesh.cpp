...
void MeshLoader::PerseMesh(
	BufferResource<VertexData>* verticesBuffer, IndexBufferResource* indicesBuffer,
	ResMesh& dstMesh) {
...
void Mesh::Init(BufferResource<VertexData>* vertexResource, IndexBufferResource* indexResource) {
...
void Mesh::Dispatch(UINT verticesParam, UINT uniqueVertexIndicesParam, UINT meshletsParam, UINT primitiveIndices) {
...
void Mesh::Dispatch(UINT verticesParam, UINT uniqueVertexIndicesParam, UINT meshletsParam, UINT primitiveIndices, UINT cullDataParam, UINT infoParam) {
...
UINT Mesh::DivRoundUp(UINT meshletCount) {
