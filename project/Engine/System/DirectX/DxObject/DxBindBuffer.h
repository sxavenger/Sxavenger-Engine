...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief ルート定数(32bit定数)としてバインドするデータと個数を保持する構造体
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief バインドするバッファの種別(仮想アドレス/ハンドル/32bit定数)
...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief リフレクションから得た1つのバインドリソースのルートパラメータ情報(レジスタ/可視性/種別)
	...
	public:
		...
		//! @brief シェーダーリフレクションのバインド記述からバインド情報を構築する
		//! @param[in] reflection  シェーダーリフレクション
		//! @param[in] _desc       入力バインド記述
		//! @param[in] _visibility シェーダー可視性
