...
namespace SxImGuizmo {
	...
	//! @brief [imguizmo移植] 4成分ベクトルの内部数学型
	...
	// Style structure
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief ギズモの色/線幅などの見た目設定を保持する構造体
	struct Style {
	public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief ギズモ操作の結果(変更種別や更新後の変換)を返す構造体
	struct GizmoOutput {
	public:
	...
	// Context structure
	////////////////////////////////////////////////////////////////////////////////////////////
	//! @brief ギズモ描画/操作の状態を保持する内部コンテキスト構造体
	struct Context {
	public:
