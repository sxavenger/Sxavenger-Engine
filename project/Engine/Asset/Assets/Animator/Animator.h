...
public:
	...
	const TimePointd<TimeUnit::second> GetDurationTime(uint32_t index) const { return animations_[index].duration; }
	const TimePointd<TimeUnit::second> GetDurationTime(const std::string& name) const;
