...
(2.)
Then include this file using the include directive,
...
#define FxaaInt2 int2
    struct FxaaTex { SamplerState smpl; Texture2D tex; float4 UVMinMax; };
#define FxaaTexTop(t, p) t.tex.SampleLevel(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), 0.0)
#define FxaaTexOff(t, p, o, r) t.tex.SampleLevel(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), 0.0, o)
#endif
/*--------------------------------------------------------------------------*/
#if (FXAA_HLSL_5 == 1)
#define FxaaInt2 int2
...
#define FxaaTexTop(t, p) t.tex.SampleLevel(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), 0.0)
#define FxaaTexOff(t, p, o, r) t.tex.SampleLevel(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), 0.0, o)
#define FxaaTexAlpha4(t, p) t.tex.GatherAlpha(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw))
#define FxaaTexOffAlpha4(t, p, o) t.tex.GatherAlpha(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), o)
#define FxaaTexGreen4(t, p) t.tex.GatherGreen(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw))
#define FxaaTexOffGreen4(t, p, o) t.tex.GatherGreen(t.smpl, clamp(p, t.UVMinMax.xy, t.UVMinMax.zw), o)
#endif
