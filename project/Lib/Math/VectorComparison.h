...
template <class _Ty>
constexpr Comparison::Flag2 operator==(const Vector2<_Ty>& lhs, const Vector2<_Ty>& rhs) noexcept {
	return { lhs.x == rhs.x, lhs.y == rhs.y };
}

template <class _Ty>
constexpr Comparison::Flag3 operator==(const Vector3<_Ty>& lhs, const Vector3<_Ty>& rhs) noexcept {
	return { lhs.x == rhs.x, lhs.y == rhs.y, lhs.z == rhs.z };
}

template <class _Ty>
constexpr Comparison::Flag4 operator==(const Vector4<_Ty>& lhs, const Vector4<_Ty>& rhs) noexcept {
